package com.example.csictgis.lab6sqlite;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateStudent(String id,String name,int position){
        Student student;
            ...
            public void onClick(View v) {
                ...
                if(shouldUpdate && student != null){
                    updateStudent(inputId.getText().toString(),
                            inputNames.getText().toString(),position);
                } else {
                    createStudent(inputId.getText().toString(),inputNames.getText().toString());
                }
            }
        });
    }
